/* -----------------------------------------------------------
This file hosts culture specific rules for Germany in German([de-DE]).
...
jTAC_Temp =
{
   ...
   dtTimeSep: ":",
   dtFirstDay: 1, 
   dtDays: ["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"],
   dtDaysAbbr: ["So","Mo","Di","Mi","Do","Fr","Sa"],
   dtDaysShort: ["So","Mo","Di","Mi","Do","Fr","Sa"],
   dtMonths: ["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember",""],
   dtMonthsAbbr: ["Jan","Feb","Mrz","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez",""],
   dtAM: null,
   dtPM: null,
