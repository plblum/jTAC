/* -----------------------------------------------------------
This file hosts culture specific rules for Italy in Italian (it-IT).
...
jTAC_Temp =
{
   ...
   dtTimeSep: ":",
   dtFirstDay: 1, 
   dtDays: ["domenica","lunedì","martedì","mercoledì","giovedì","venerdì","sabato"],
   dtDaysAbbr: ["dom","lun","mar","mer","gio","ven","sab"],
   dtDaysShort: ["do","lu","ma","me","gi","ve","sa"],
   dtMonths: ["gennaio","febbraio","marzo","aprile","maggio","giugno","luglio","agosto","settembre","ottobre","novembre","dicembre",""],
   dtMonthsAbbr: ["gen","feb","mar","apr","mag","giu","lug","ago","set","ott","nov","dic",""],
   dtAM: null,
   dtPM: null,
